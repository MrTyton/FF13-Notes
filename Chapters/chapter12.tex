...
\end{itemize}
\end{menu}
\textbf{Take note of your gil.} Refer to the following chart to determine which chests to pick up for the rest of the chapter.
...
If you got a Gold Dust: skip the Punisher if your gil is above 21,250, and skip the Mistilteinn.\\
