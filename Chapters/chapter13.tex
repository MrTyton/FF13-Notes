...
\end{itemize}
\end{battle}
Take the left elevator, then \textbf{Ethersol} and \textbf{Deceptisol} while it rises. Activate \textbf{Fortisol} on the first jump, \textbf{Aegisol} on the second jump, and menu on the last jump.
\begin{menu}
\begin{itemize}
    \crystarium
    \begin{itemize}
