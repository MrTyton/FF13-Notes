...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Buy
        \begin{itemize}
            \item Superconductor x44 + 1 for each Doctor's Code remaining
        \end{itemize}
    \end{itemize}
    \columnbreak
    \item Creature Comforts
...
If you're using an ethersol for Barthandelus 2, make the first paradigm a Smart Bomb. \pickup{Ethersol}{next to the auto-jump}
